...
export default function WhatsAppButton({
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-ink shadow-lg transition-transform hover:scale-110"
    >
